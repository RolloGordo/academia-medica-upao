  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Información de tu cuenta de docente</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Detalles de tu cuenta como docente</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Avatar */}
          <div className="flex items-center space-x-4">
            <div className="h-16 w-16 rounded-full bg-green-600 flex items-center justify-center text-white font-bold text-2xl">
